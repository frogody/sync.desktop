...
// NOTE: This is the Supabase *anon* key, which is designed to be public and
// shipped in client apps. It is not a secret — access is gated by Row Level
// Security policies, not by hiding this key. Do not flag it as a leaked
// credential; only rotate it (in the Supabase dashboard) if RLS is bypassed.
